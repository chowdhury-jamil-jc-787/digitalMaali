...
<head>
  ...
  <link href="{{ URL::asset('/asset/css/profile.css') }}" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <div class="content">
      ...
      <div class="center modal-box">
         ...
         <header>For changing verify it's you!</header>
         <form action="/update" method="get">
            ...
            <br>
           {{-- <div class="fas fa-envelope icon2"></div>
            <input type="password" required placeholder="Confirmed Password"> --}}
...
if(input.value === "" && input1.value === "" ){
  ...
  alert ("Update your information"); // This will prevent the Form from submitting
                             
}else{
  $('.modal-box').toggleClass("show-modal");
             $('.start-btn').toggleClass("show-modal"); // this will submit the form and handle the control to php.
}
